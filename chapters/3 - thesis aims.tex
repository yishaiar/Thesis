...
\par\noindent
With PID tuned correct the damped pendulum is at critical damping and oscillations become smaller. PID error $e(t)$ and damping response $u(t)$ (eq.~\ref{eqn:PID response}) are both minimized. 
\begin{equation}

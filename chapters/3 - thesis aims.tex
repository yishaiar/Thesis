...
\par
The measurement base limites are basic energy level quantum uncertaintyand measurement shot noise.
\begin{equation}
\frac{1}{2}\kappa <\delta\theta^2>= \frac{4}{\hslash\omega}    \label{eqn:basic uncertainty}
\end{equation}
\begin{equation}
\delta\theta= \sqrt{\frac{\hslash\omega}{2\kappa}} \approx
cdot10^{-14} [rad]    \label{eqn:basic uncertainty}
\end{equation}

...
\end{equation}
Assuming above basic energy level the quantum uncertainty due to Brownian motion is temperature dependent \cite{howell2019}, at room temperature ($T = 300[k]$) the noise could be estimated to:
\begin{equation}

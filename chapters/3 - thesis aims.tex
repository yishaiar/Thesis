...
\par\noindent
The quantum uncertainty due to Brownian motion is the main noise source. As shown in eq.~\ref{eqn:Brownian uncertainty 2}, the quantum uncertainty at a given temperature (assuming above basic energy level) is:

\begin{equation}
\delta\theta = \sqrt{\frac{k_B T}{\kappa}} = \sqrt{\frac{k_B}{\kappa}}\sqrt{T} \label{eqn:Brownian uncertainty 3}
\end{equation}
\begin{equation}

...
\noindent
Shot noise, using a split detector in an interferometric technique, is even on all frequencies. Shot limit when integrating over a long time could be calculated as:
\begin{equation}

...
\par\noindent
The quantum uncertainty due to Brownian motion is the main noise source. As shown quantum uncertainty at a given temperature (assuming above basic energy level) is eq.~\ref{eqn:Brownian uncertainty 2}:

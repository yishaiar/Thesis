...
\end{equation}
Assuming above basic energy level the quantum uncertainty due to thermal energy is temperature dependent \cite{howell2019}, at room temperature ($T = 300[k]$) the noise could be estimated to:
\begin{equation}
...
\par\noindent
The pendulum is placed inside a vacuum chamber, reducing Brownian motion from the environment and the heat coupling, acoustic waves and friction. The vacuum chamber is reducing magnetic noise as a Faraday cage. The noise reduction results with smaller pendulum oscillations, which enables to damp and cool the pendulum temperature. 
\begin{equation}

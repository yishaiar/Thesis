...
\par\noindent
The cooling system is built using two led light sources placed on each side of the pendulum. The leds are modulated at high speeds using a simple arduino microcontroller. The modulated light is causing a small external radiation torque, which damps down the ossiclations.
\par\noindent

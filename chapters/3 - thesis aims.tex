...
\par\noindent
The pendulum is placed inside a vacuum chamber, reducing acoustic waves and friction, Brownian motion from the environment and the thermal coupling. The vacuum chamber is reducing magnetic noise as a Faraday cage. The noise reduction results with smaller oscillations amplitude %\delta\theta%: 
\begin{equation}

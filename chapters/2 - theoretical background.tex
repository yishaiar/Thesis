...
Acoustic waves is an energy propagating through material, by adiabatic compression and decompression (acoustic pressure %p%). Acoustic waves propagate with intensity and velocity depending on the material. The acoustic intensity, is the power carried by acoustic waves per unit area $[\frac{W}{m^2}]$.
\begin{equation}
I = pV      \label{eqn:acoustic_intensity}
\end{equation} 
One dimension acoustic wave equation, where the amplitude is acoustic pressure.
\begin{equation}

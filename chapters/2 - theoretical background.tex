...
\begin{equation}
\kappa = \frac{GJ}{h} = \frac{G}{h} \frac{\pi}{2} (\frac{d}{2})^4 = \frac{G}{h} \frac{\pi d^4}{32}   \label{eqn:torsion_coefficient_homogeneity}
\end{equation}
\par\noindent
...
\end{equation}
Where $\theta_{max}$ is the oscillations amplitude, $\omega_0$ is the natural resonant frequency of the oscillations.
\begin{equation}

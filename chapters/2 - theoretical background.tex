...
The brownian motion kinetic energy is propotional to the temperture. The  quantum uncertainty due to brownian motion cause noise. The uncertainty at a given temperature (assuming noise is much higher than basic energy level). 
\begin{equation}

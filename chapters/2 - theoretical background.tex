...
\begin{equation}
p = F\cdot u =  R p\cdot u=  \frac{4}{m_1} R^2 m_0^2 v^2 = \frac{4}{m_1} (\frac{N}{V} v A)^2 (\frac{M}{N_A})^2 v^2  =  \frac{36 A^2 P^2 }{m_1} =  \frac{12 A }{m_1} (\frac{PM}{N_A}  )  \sqrt{\frac{3K N_A T}{M}} 

...
\end{equation}
The incident radiation pressure, where $A$ is the surface area, $c$ the speed of light. Assuming the light Direction is perpendicular to surface, and angle is neglected. Also, the light variation over the surface is negligible.

...
\begin{equation}
p =A\cdot(j_{absorb}-j_{emit})= A \cdot[\epsilon_1\sigma T^4-(\epsilon\sigma T_0^4+(1-\epsilon)\epsilon_1\sigma T^4)] = A \sigma\epsilon[\epsilon_1 T^4- T_0^4] \approx A \sigma\epsilon[ T^4- T_0^4]  \label{eqn: Stefan–Boltzmann power}
\end{equation}

...
\begin{figure}[htbp]
	\centering
	\fbox{\includegraphics[scale=0.2]{\main/images/2 - theoretical background/damping.jpg}}
	\caption[Damped oscillators]{Damped oscillators; \cite{underdamped-system}}
...
\begin{figure}[htbp]
	...
	\caption[PID controller feedback loop]{PID controller block diagram; from circuitdigest.com}

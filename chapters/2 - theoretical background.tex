...
\end{equation}
The typical reference intensity value for air at room pressure $P_0  \approx 1\cdot10^{5}[pa] $ and room temperature and  is $<I_0> \approx 1\cdot10^{-12}[\frac{W}{m^2}]$, resulting with power given by:
\begin{equation}
p(P) \approx  A\frac{<I_0>}{P_0^2}\cdot P^2 \approx 1\cdot10^{-22}AP^2

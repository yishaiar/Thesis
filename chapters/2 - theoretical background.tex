...
\begin{equation}
p = F\cdot u =  2 R m_0 v \cdot \frac{2Rm_0}{m_1} = 4 R^2 m_0^2  \frac{v}{m_1} = 4 (\frac{N}{V} v A)^2 (\frac{M}{N_A})^2  \frac{v}{m_1}=12 \cdot 3^{1/2} A^2 P^2 \frac{1}{m_1}  (\frac{M}{k_B T N_A})^{1/2}  

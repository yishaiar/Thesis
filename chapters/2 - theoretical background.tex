...
\begin{equation}
H(p,x) = \frac{p^2}{2m}+\frac{m\omega^2x^2}{2}k_BT  \label{eqn:Hamiltonian}
\end{equation}
It can be shown that the partition function $Z$ for a classical continuous system with one degree of freedom is:
\begin{equation}
Z = \frac{1}{h}\int_{-\infty}^{\infty}dx\int_{-\infty}^{\infty}dp 
\label{eqn:partition function}
\end{equation}
It can be shown that the partition function $Z$ for the simple harmonic oscillator is: 
\begin{equation}

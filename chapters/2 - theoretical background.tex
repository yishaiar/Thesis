...
\end{equation}
It can be shown from eq.~\ref{eqn:heat conduction}, that the gas flow velocity $v$ is given by:
\begin{equation}
v = \sqrt{\frac{3RT}{M}}   
...
\begin{equation}
p =  \lambda A \frac{\Delta T}{\Delta x} =\frac{l}{3} \frac{MP}{RT} c_v v A \frac{\Delta T}{\sqrt{\frac{1}{3} l^2 }} = \frac{M P c_v  A \Delta T}{\sqrt{3}RT} \sqrt{\frac{3RT}{M}}    

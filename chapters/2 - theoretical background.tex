...
\end{equation}
When the the oscillator is extremely underdamped ($\xi << 1$) the damping time is very large and frequency change negligible, resulting with an approximately undamped oscillator.
\par\noindent

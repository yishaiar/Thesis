...
\end{equation}
For a diluted gas the viscosity $\mu$ is pressure dependent. The viscosity of an ideal gas is given by:
\begin{equation}
\mu(P) = \alpha l \rho \sqrt{\frac{2\pi k_B  T}{\pi m}} = \alpha l \frac{MP}{RT}  \sqrt{\frac{2\pi k_B  T}{\pi m}}      \label{eqn:viscosity}
\end{equation}

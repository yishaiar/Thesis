...
\begin{equation}
p = F\cdot u =  2 R m_0 v \cdot \frac{2Rm_0}{m_1} = 4 R^2 m_0^2  \frac{v}{m_1} = 4 (\frac{N}{V} v A)^2 (\frac{M}{N_A})^2  \frac{v}{m_1}=4 (\rho_N A)^2 (\frac{M}{N_A})^2  \frac{(\frac{3RT}{M})^{3/2}}{m_1}

...
\end{equation}
Where $\alpha$ is a numerical constant, $l$ is the mean free path of the gas particles and $m$ is the molecular mass. The viscosity is density dependent, resulting with an ideal gas pressure dependency. It can be shown that for an ideal gas the heat flow propagation distance is $\Delta x ^2  = \frac{1}{3} l^2 $, and the thermal conductivity $\lambda$ is:
\begin{equation}
\lambda  = \frac{l}{3}\rho c_v v = \frac{l}{3} \frac{MP}{RT} c_v v   \label{eqn:heat conduction coefficient}
\end{equation}
Where $c_v$ is the specific heat capacity of the material.
...
There is thermal energy coupling from the environment on the sides of the medium, phonons are penetrating and pass energy to the gas particles inside the medium. 

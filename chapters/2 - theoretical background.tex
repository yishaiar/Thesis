...
\end{equation}
The Brownian motion random fluctuations cause an average force $F$ given by:
\begin{equation}
F = \frac{dk}{dt} = Rcol_{RMS}\cdot\frac{dk_{particle}}{dt}= \sqrt{Rcol}\cdot 2 m v    \label{eqn:Brownian coupling}
\end{equation}

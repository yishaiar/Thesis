...
The system is a damped oscillator if there is also a damping torque $\tau = -b\cdot\dot{\theta}$. The damping torque is opposite to the oscillator's angular velocity $\dot{\theta}$, where $b$ is the oscillator damping coefficient. Thus, eq.~\ref{eqn:undamped_motion_equation} becomes:
\begin{equation}

...
\begin{figure}[htbp]
	\centering
	\fbox{\includegraphics[scale=0.3]{\main/images/2 - theoretical background/torsion_pendulum.pdf}}
	\caption[Damped oscillators comparison]{Damped oscillators comparison; from sciencedirect \cite{howell2019}}
	\label{fig:damped_oscillators}
\end{figure}
\par\noindent

...
\begin{equation}
Re= \frac{\rho u L}{\mu}     \label{eqn:Reynolds number}
\end{equation}
Where $\rho$ is the gas density, $u$ is the flow speed, $L$ is the medium characteristic dimensions and $\mu$ is the fluid viscosity. The density $\rho$ of an ideal gas: 
\begin{equation}

...
\par\noindent
The field caused by test mass $M$ at a specific point is calculated by measuring the gravitational force. Test mass $M$ is much larger than each mass $m$, ensuring a negligible influence on the behavior of $M$.  

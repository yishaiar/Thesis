...
\end{equation}
When the light field direction is perpendicular to the surface the radiation force is:
\begin{equation}
F \approx   2\frac{\eta\cdot \Theta_{source}\cdot cos^2(\alpha)}{{A\cdot c}}A \approx  \frac{2\eta\Theta_{source}}{{c}}\cdot \frac{A}{A} \approx\frac{2\eta\Theta_{source}}{{c}} \label{eqn:radiation_force_power}
\end{equation}

...
\end{equation}
Where $\alpha$ is a numerical constant, $l$ is the mean free path of the gas particles and $m$ is the molecular mass. It can be shown that for an ideal gas the thermal conductivity $\lambda$ is:
\begin{equation}
\lambda(P)  = \frac{l}{3}\rho(P) c_v v    \label{eqn:heat conduction coefficient}
\end{equation}
Where $c_v$ is the specific heat capacity of the material and the heat flow propagation distance is $\Delta x ^2  = \frac{1}{3} l^2 $.

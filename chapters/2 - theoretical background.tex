...
\end{equation}
\par\noindent
Where $P$ is the actual pressure, $P_0$ is the average pressure, $k$ is the acoustic wave number and $\omega$ is the wave angular frequency. The acoustic intensity $I$ is the power carried by acoustic waves, given by:
\begin{equation}
I = P u  = P\sqrt{\frac{K_s}{\rho}} [\frac{W}{m^2}]    \label{eqn:acoustic_intensity}
\end{equation}

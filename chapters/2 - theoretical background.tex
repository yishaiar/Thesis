...
\subsubsection{Drag}
Drag is the friction caused by gas resistance, which is dependent on the relative velocity $v$ between the gas and the object. At higher pressures, when Reynolds number is relatively high the drag is proportional to the square of the relative velocity:
\begin{equation}

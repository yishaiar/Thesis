...
\begin{equation}
p =A\cdot(j_{absorb}-j_{emit})= A \cdot[\epsilon_1\sigma T^4-(\epsilon\sigma T_0^4+(1-\epsilon)\epsilon_1\sigma T^4)] = A \cdot\sigma\epsilon[\epsilon_1 T^4- T_0^4] = \epsilon (T_0,\lambda)\sigma [T^4-T_0^4]  \label{eqn: Stefan–Boltzmann power}
\end{equation}

...
\begin{equation}
p = F\cdot u =F\cdot u =  2 R m_0 v \cdot \frac{2Rm_0v}{m_1} = 4 R^2 m_0^2 v^2  \frac{1}{m_1} = 4 (\frac{N}{V} v A)^2 (\frac{M}{N_A})^2 v^2  \frac{1}{m_1}= \frac{36}{m_1} (A k_B T \rho_N)^2 

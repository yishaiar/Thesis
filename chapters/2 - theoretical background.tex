...
\end{equation}
\par\noindent
Where $\dot{Q}$ is the rate of heat flow propagating a distance of $\Delta x$ through a material with surface area $A$, thermal conductivity $\lambda$ and specific heat capacity $c_v$ .The heat flow is proportional to the temperature difference $\Delta T$. Eq.~\ref{eqn:heat conduction} shows that the rate of thermal energy coupling from the environment is proportional to the gas pressure. Reducing the pressure reduces the energy coupling rate.

...
\par\noindent
While the black body emits radiation $j_{emit}$, black bodies around also radiate by their temperature $T$, some of the incident radiation $j$ is reflected $j_{reflect}$. The reflectance is given from Kirchhoff's law $r=1-\epsilon$. For black body with temperature $T_0$ with incident radiation of an ideal black body with temperature $T$, the net absorbed power $p$ is: 
\begin{equation}
...
\par\noindent
Additionally, the black body radiation of the environment causes momentum and energy exchange due to photon collisions, similar to the gas particles Brownian motion. The collisions are only depended on the temperature of the environment black bodies.

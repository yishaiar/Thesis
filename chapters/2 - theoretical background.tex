...
\par\noindent
Solving eq.~\ref{eqn:damped_motion_equation_2}, the oscillator could be either undamped, overdamped, critically damped or underdamped. The motion equations when boundaries are $\theta(0) = \theta_{max}$ and $\dot{\theta}(0) = 0$:

...
Acoustic waves are adiabatic compression and decompression waves propagating through a material. The acoustic wave equation, where the amplitude is an acoustic pressure difference is:
\begin{equation}
P = P_0 cos(\omega t -\overrightarrow{k}\cdot\overrightarrow{r})       \label{eqn:acoustic_pressure}
\end{equation}
Where $P$ is the actual pressure, $P_0$ is the average pressure, $k$ is the wave number 
\begin{equation}

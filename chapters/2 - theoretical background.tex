...
\begin{equation}
F_{drag}(P,v) = -\frac{1}{2}\rho(P) C_d \pi r^2\cdot v^2 = -b\cdot v^2 
...
and the Reynolds number approaches zero it can be shown that $C_d \rightarrow \frac{24}{Re}$, resulting with 

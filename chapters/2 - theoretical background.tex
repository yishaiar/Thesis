...
\begin{equation}
F_{drag} = -\frac{1}{2}\rho v^2 C_d A  = -\frac{1}{2}\rho v^2 \frac{24}{Re} A = -\frac{1}{2}\rho v^2 \frac{24\mu}{\rho v d} \frac{\pi d^2}{4} = -3\pi\mu d\cdot v
...
The drag force is pressure dependent, until pressure decreases to a level in which the drag  is negligible.

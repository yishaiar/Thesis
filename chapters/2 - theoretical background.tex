...
\begin{equation}
Re= \frac{\rho v L}{\mu}     \label{eqn:Reynolds number}
\end{equation}
Where $\rho$ is the gas density, $v$ is the flow speed, $L$ is the medium characteristic dimensions and $\mu$ is the fluid viscosity. The density $\rho$ of an ideal gas: 
\begin{equation}
...
\subsubsection{Drag}
Drag force $F_{drag}$ is the friction caused by gas resistance, which is dependent on the relative velocity $v$ (the flow speed) between the gas and the object. At higher pressures, when Reynolds number is relatively high the drag is proportional to the square of the relative velocity $v$:
\begin{equation}
F_{drag} = \frac{1}{2}\rho v^2 C_d A  \label{eqn:drag_force}
\end{equation}
...
\begin{equation}
F_{drag} = \frac{1}{2}\rho v^2 C_d A  = \frac{1}{2}\rho v^2 \frac{24}{Re} A = \frac{1}{2}\rho v^2 \frac{24\mu}{\rho v L} A = \frac{12\mu vA}{L} 

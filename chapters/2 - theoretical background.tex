...
\end{equation}
Accordingly, it the approximated that $\theta_1 \approx \theta_2 = \theta$, where $\theta$ is the tilt angle of the torsion. Which results with response the net force gradient, as can be seen by the dependency on $\frac{}{r_0^3}$.

...
The density $\rho$ of an ideal gas: 
\begin{equation}
...
Where $M$ is the gas molar mass, and $R$ is the ideal gas constant. Thus, for a constant temperature $T$ the medium pressure $P$ is proportional the gas density $\rho$. 
\subsubsection{Flow characteristics}

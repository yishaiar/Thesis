...
\end{equation}
The field caused by a mass $M$ at a specific point is calculated by measuring the gravitational force. The gravitational force is caused by a known mass $m$ (a test mass). Test mass $m$ is much smaller than the mass $M$, which ensures that there is a negligible influence on the behavior of $M$.  
...
\end{equation}
\begin{equation}
\overline{\theta} = \frac{\tau}{\kappa}    \label{eqn:theta average}
\end{equation}

...
\begin{equation}
p = F\cdot v = R\cdot 2mv \cdot v = \frac{N}{V} v A \cdot 2mv\cdot v = 2m\frac{P}{K_B T}  A   (\frac{3RT}{M})^{3/2} = 6 P A   \sqrt{\frac{3RT}{M}}     \label{eqn:Brownian power}
\end{equation}
...
\begin{equation}
p_{emit} = \sigma\epsilon(T_0) A T_0^4  \label{eqn: Stefan–Boltzmann law}
\end{equation}
...
\begin{equation}
p = p_{absorb}-p_{emit} = \sigma\epsilon(T_0) A (T^4-T_0^4)  \label{eqn: Stefan–Boltzmann power}
\end{equation}

...
\begin{equation}
Z = \frac{1}{h}\int_{-\infty}^{\infty}dx\int_{-\infty}^{\infty} dp exp(-\frac{p^2}{2 m k_B T}) exp(-\frac{\kappa x^2}{2 k_B T }) = \frac{1}{h} \sqrt{2\pi m k_B T} \sqrt{2\pi k_B T \kappa} = \frac{k_B T}{\hslash\omega} = \frac{1}{\beta\hslash\omega}

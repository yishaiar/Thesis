...
\end{equation}
\par\noindent
When $\xi > 1$ the oscillator is overdamped; when there is high friction, the system cannot oscillate and it decays exponentially to the equilibrium position. When defining $xi'  = \frac{\xi}{\sqrt{\xi^2 - 1}}$ the motion is given by: 
\begin{equation}

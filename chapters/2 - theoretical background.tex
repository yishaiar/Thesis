...
\end{equation}
The heat propagates distance of $\Delta x$ through a material with surface area $A$. Eq.~\ref{eqn:heat conduction} shows that the thermal coupling power is proportional to the to the temperature difference $\Delta T$ and the gas pressure.

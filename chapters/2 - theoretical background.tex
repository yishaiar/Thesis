...
\end{equation}
Where $M$ is the gas molar mass, and $R$ is the ideal gas constant. Thus, for a constant temperature $T$ the medium pressure $P$ is proportional to the gas density $\rho$ and to the Reynolds number $Re$. 
...
\begin{equation}
Q_{des} = q_{des} A\frac{t_0}{t}  \label{eqn:energy-mass-equivalence-relation}
\end{equation}

...
\end{equation}
Eq.~\ref{eqn:acoustic power} shows that the acoustic power is pressure dependant. When the gas pressure is reduced, the acoustic pressure is lower and less power is carried.

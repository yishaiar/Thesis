...
\end{equation}
The damping torque, is a drag torque (friction) which is opposite to the oscillator's angular velocity $\dot{\theta}$, where $b$ is the oscillator damping coefficient. 
\par\noindent

...
Faraday cage is a cage made by a continuous covering of a conductive material which is used to block electromagnetic fields. External electrical fields causes an electric charge distribution in the conductive cage without passing inside. Faraday cage cannot prevent fields caused by electric charges placed inside.
\par
The cage blocks better penetration of high frequency magnetic fields, depending on the material skin depth $\delta$ wich determines the shield penetrating frequencies. Electric current decays exponentially with depth through the material, the thicker the shield the better at attenuating lower frequency fields.
\begin{equation}

...
\end{equation}
\begin{equation}
Q =  \frac{\pi\kappa\theta_{max}^2}{T\cdot(\frac{\theta_{max}\cdot\pi\tau_{max}}{T} -p)} =
\frac{\pi}{T}\cdot\frac{\kappa\theta_{max}^2}{\frac{\theta_{max}\cdot\pi\tau_{max}}{T} -p}\stackrel{p\approx 0}{=}
\label{eqn:Q}
\end{equation}
\begin{figure}[htbp]
	\centering

...
\par\noindent
The average energy of a black body radiation photon is given by $E=2.7 k_B T$, when the pendulum temperature is  $T_0 = 0K$, the black body radiation is given by \cite{WOODS201444}:
\begin{equation}
p = \sigma\epsilon(T_0=0) A T^4 = N\cdot E = \frac{\sigma\epsilon(T_0=0) A T^4}{2.7 k_B T}\cdot{2.7 k_B T}  \label{eqn: max Stefan–Boltzmann power}
\end{equation}

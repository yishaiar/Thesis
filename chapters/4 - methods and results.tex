...
\end{multicols}
\par\noindent
The black body radiation is emitted by photons, although we don't have an accurate estimation of the particles RMS, we estimate a similar reduction of the effective power. The measurement system is placed inside an acoustic box, further reducing the acoustic power.    
\par\noindent

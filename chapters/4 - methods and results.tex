...
\begin{equation}
V = \frac{\sum PW\cdot V_d}{\sum T} = \frac{N\cdot PW\cdot V_d}{N\cdot T} = \frac{V_d}{100}\cdot D   \label{eqn:analog voltage}
\end{equation}
...
\begin{equation}
V(t) = \frac{V_d}{100}\cdot D(t)   \label{eqn:analog voltage}
\end{equation}

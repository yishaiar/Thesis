...
\end{equation}
\par\noindent
The setup can produce very small external torques with high dynamic range; light sources each with 1 watt maximum power and 8bit modulation steps can produce torques up to $\tau = 5\cdot10^-{10} [N\cdot m]$ with modulation steps of $\Delta\tau = 2\cdot10^-{12} [N\cdot m]$. 

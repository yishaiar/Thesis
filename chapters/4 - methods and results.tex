...
The modulated light sources are composed of two LED light sources driven by an Arduino microcontroller, resulting with a linear response of the torque to the PID control (see eqn:radiation torque) and minimizing overshoot, while having a fast response time and minimizing phase delay.
\par\noindent

...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.38]{\main/images/4 - methods and results/measured oscillation angle.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.38]{\main/images/4 - methods and results/measured oscillation angle1.png}

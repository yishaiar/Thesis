...
\end{equation}
The circuit is composed of a blue LED with $V_l\approx 4.5V$, supply voltage of 6 PWM Arduino pins in parallel (eq.~\ref{eqn:pwm current}, eq.~\ref{eqn:pwm voltage}) and resistor $R = 200\Omega$, the LED radiant flux $[W]$ is given by:
\begin{equation}

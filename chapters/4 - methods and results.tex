...
\begin{equation}
\frac{M}{r_0^3} \approx \frac{\overline{\theta}\pm \delta\theta}{\frac{3GT^2cos\theta sin\theta}{4\pi^2 }} \approx 5\cdot 10^{7} [\overline{\theta}\pm \theta_{max}]
\label{eqn:theta average}
\end{equation}
Assuming a measured mass $M$ at distance $r_0 = 1[m]$, the measurement sensitivity at room temperature is limited to $M\geq 2[kg]$. When PID 
At room temperature the measurement sensitivity is limited to   

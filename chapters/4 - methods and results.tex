...
\par\noindent
Due to tourqe power and phase delay, the PID has a lower limit to the damping angle. Shown in fig.~\ref{fig:measured oscillation angle2}, are the damped oscillation after the PID reached its limit. The PID is able to keep the small amplitude constant over time, enabling to integrate over the results, and have  gravitational measurements.

...
\end{equation}
The PID controlled torque $ $ needs to habe high modulation dynamic range to continuously damp the oscillations (eq.~\ref{eqn:friction_torque_pid}), and a maximal torque given by eq.~\ref{eqn:damping_torque_pid} to achieve critical damping.
\par\noindent

...
As shown previously, the PID damping process is damping the torsional pendulum amplitude. When the torsional pendulum is damped beyond the technical noises, the amplitude is limited by the temperature quantum uncertainty (eq.~\ref{eqn:Brownian uncertainty 3}). When the PID damping process is damping the torsional pendulum amplitude below the temperature quantum uncertainty, the torsional pendulum temperature is effectively lowered by the damping process.
\par\noindent
As shown in chapter.~\ref{chapter:Theoretical background} the gravimetric measurement is conducted by measuring the average equilibrium angle of the torsional pendulum. The measurement is limited by the quantum uncertainty due to the temperature quantum uncertainty. The gravimetric measurement is given by:
\begin{equation}

...
\end{equation}
The driving circuit is composed of supply voltage with $N=6$ PWM Arduino pins in parallel, and resistor $R = 360\Omega$, the LED output power is given by:
\begin{equation}
P(t) = I_{total}\cdot (-V_l) = (NI)\cdot (-V_l) = -N\frac{V-V_d}{R}\cdot (-V_l)  =-N V_l\frac{\frac{V_d}{100}\cdot D(t)-V_l}{R} =-\frac{6V_l}{}\frac{0.05\cdot D(t)-V_l}{360}  \label{eqn:led power}
\end{equation}

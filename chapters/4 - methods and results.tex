...
\FloatBarrier
\par\noindent
The torsional pendulum design, shown in fig.~\ref{fig:pendulum front}, is composed of thin rod with length $2l$, two identical masses $m$ on the sides, a front mirror and a balancing mass. 
...
\end{equation}
Where $m_1$, $m_2$ are the masses of the mirror and the balancing mass, and $r_1$, $r_2$ are respectively their distance from the pendulum's center of mass. The spring allows adjusting the distance, given by: 
\begin{equation}

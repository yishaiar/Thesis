...
\par\noindent
Due to tourqe power and phase delay, the PID has a lower limit to the damping angle. The PID is able to keep a small amplitude of $\theta_{max}\approx 1\cdot 10^{-7}$ constant over time, enabling to integrate over the results, and have gravitational measurements of..
\par\noindent

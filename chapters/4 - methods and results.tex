...
\end{equation}
The supply voltage in the driving circuit is composed of multiple PWM Arduino pins in parallel, the LED output power is given by:
\begin{equation}
P(t) = I_{total}\cdot (-V_l) = (NI)\cdot (-V_l) = N(-V_l)\frac{V-V_d}{R}  =-N\frac{V_l\frac{V_d}{100}\cdot D(t)-V_l^2}{R}  \label{eqn:led power}
\end{equation}

...
\par\noindent
Except for the torsional mode we are measuring there is also a bouncing mode with a period of $T_b\approx 2\pi\sqrt{\frac{h}{g}}\approx 1[s]$, which is masking the measurement with amplitude of $\theta_{max}^b $

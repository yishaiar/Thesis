...
\par\noindent
For a torsional pendulum, where $D$ is the string diameter, and I is the moment of innertia:
\begin{equation}
...
\par\noindent
In order to minimize the magnetic noise in the measurements, the torsion pendulum was made out of stainless steel 316 (instead of 304). Stainless steel 316 has a lower relative magnetic permeability $\mu_r$ \cite{SS316}.
\par\noindent
The experiment, is constructed using a front mirror, the angle displacement causes a mirror tilt.  
\begin{figure}[htbp]
	\centering
	\fbox{\includegraphics[scale=0.4]{\main/images/4 - methods and results/pendulum_front.png}}

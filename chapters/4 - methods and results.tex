...
\end{equation}
The analog voltage $V_a$ is the average voltage, determined by the duty cycle. The Arduino is able to modulate the duty cycle, resulting in modulation to the analog voltage:
\begin{equation}
...
\end{equation}
The clock is having about 120 full periods of the square wave before changing to a new duty cycle value, having a $500[Hz]$ PWM frequency for the analog voltage modulation. 
\par\noindent 

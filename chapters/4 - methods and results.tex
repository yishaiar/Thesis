...
\begin{equation}
p =  n_p\frac{ k^2}{m_1} = \frac{j_{ref}}{E}A\cdot\frac{ \frac{2E}{c}}{m_1} +\frac{j_{ab}}{E}A\cdot\frac{ \frac{E}{c}}{m_1} = \frac{A}{ c m_1} (2j_{ref}+j_{ab}) =\frac{A}{ c m_1} (2-\epsilon)\sigma T^4 = 

...
\begin{equation}
D = \frac{PW}{T}  \label{eqn:duty cycle}
\end{equation}
The analog voltage value is determined by the duty cycle:



 100\% duty cycle meaning power is always on and output is the full Vcc, 0\% power off and 50\% signal is on and off equally resulting with output of half. 
\par\noindent

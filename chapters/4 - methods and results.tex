...
\end{equation}
Where $m_1$, $m_2$ are the masses of the mirror's and the weight, and $r_1$, $r_2$ are respectively their distance from the center of the pendulum. The spring allows adjusting th distance, given by: 
\begin{equation}

...
\par\noindent
When the PID reaches its limit, due to power and phase delay. The PID is able to keep a constant small amplitude angle, shown in fig.~\ref{fig:measured oscillation angle2}, enabling to integrate over the results and get even better gravitational measurements.

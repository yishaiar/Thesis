...
\begin{figure}[htbp]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.4]{\main/images/4 - methods and results/measured oscillation angle.png}}
...
\begin{figure}[htbp]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.4]{\main/images/4 - methods and results/measured oscillation angle1.png}}

...
\end{easylist}
The black body radiation and heat flow, are temperature dependent and thus grow gradually while the torsional pendulum temperature is reduced. Due to to the remaining noises, the initial oscillations amplitude is $\theta_{max} =\theta_{max} = 5\cdot10^{-7}[rad]$. 
\subsection{results}

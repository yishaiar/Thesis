...
\par\noindent
In order to balance the pendulum so that the mirror will not have an initial downward tilt, the pendulum center of mass needs to be adjusted. With a balanced pendulum the downward torques $\tau_y$ would be canceled out:
\par\noindent
The center of mass is adjusted using a balancing mass $m_1$ to the mirror weight $m_2$ from behind:
\begin{equation}

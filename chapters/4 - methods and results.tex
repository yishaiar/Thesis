...
Assuming negligible friction, the energy lost in one cycle is the work done at the cycle $W_T$, which is the difference between the PID work and the environment coupled noise power $p$. The coupled noise power at the cycle is independent of time. The torsional pendulum Quality factor is given by:
\begin{equation}

...
As shown previously, there are environment noises affecting the torsional pendulum (eq.~\ref{eqn:Brownian power}, eq.~\ref{eqn:heat conduction}, eq.~\ref{eqn:acoustic power}, eq.~\ref{eqn: Stefan–Boltzmann power}). Assuming gas and environment temperature of $T = 298K$ and pendulum temperature $T_0 = 0K$ (maximal noise power), the maximal power of the noises are given by:
\begin{easylist}
& Black body radiation power $p=0.121[W]$ \cite{WOODS201444}.
& Thermal flow power $p=0.083[W]$.
& Brownian motion power $p=0.346[W]$.

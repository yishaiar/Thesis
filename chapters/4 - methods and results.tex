...
\FloatBarrier
\par\noindent
The design of torsional pendulum and vacuum chamber was carried out using Solid Works.
The experiment system, shown in fig.~\ref{fig:Total chamber}, is designed to minimize environment noises. Therefore, the torsional pendulum is placed inside a vacuum chamber, keeping the pendulum at low pressure reduces Brownian motion, acoustic waves and friction. The magnetic noise is reduced by choosing low magnetic permeability materials, avoiding capacitance and by having the vacuum chamber as a Faraday Cage. The vacuum chamber is placed inside seismic box, further reducing acoustic waves and magnetic noises from the environment. 
\par\noindent
In order to maintain low pressure for long periods, system is designed to minimize the outgassing rate, by both choosing low outgassing materials and avoiding air pockets inside the devices. 

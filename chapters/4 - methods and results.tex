...
\end{equation}
The radiation-pressure net torque is modulated by changing the difference between the light sources' flux (enabling high dynamic range to modulation). As shown in eq.~\ref{eqn:damping_torque_pid}, to damp the torsional pendulum the maximal net torque is given by:
\begin{equation}

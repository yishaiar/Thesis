...
\par\noindent
\begin{equation}
p_{RMS} =  6 A \sqrt{\frac{P k_B T}{V}}    \sqrt{\frac{3RT}{M}} =6 A T k_B \sqrt{\frac{3 N_A P}{V M}}      \label{eqn:Brownian power}
\end{equation}
\begin{equation}
p =  \sqrt{\frac{M}{RT}} c_v  A \sqrt{\frac{P k_B T}{V}}  T = \sqrt{\frac{M}{N_A }} c_v k_B  A \sqrt{\frac{P  }{V}}  T

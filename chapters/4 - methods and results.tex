...
\par\noindent
Assuming negligible air friction, the energy lost in one cycle  $W_T$ is the work done at the cycle, which is the difference between the PID work and the environment coupled noise power $p$. The sum of the kinetic and potential energy is the energy stored in the torsional pendulum, and the quality factor $Q$ is given by:
\begin{equation}

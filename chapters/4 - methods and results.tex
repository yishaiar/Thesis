...
\par\noindent
For a torsional pendulum with length of $2l$, and two identical masses $m$ on the sides (eq.~\ref{eqn:moment_inertia}), the period is given by (eq.~\ref{eqn:undamped_omega}): 
\begin{equation}

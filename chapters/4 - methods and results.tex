...
As shown previously, there are friction and environment energy sources affecting the torsional pendulum movement (eq.~\ref{eqn:drag force}, eq.~\ref{eqn:Brownian power}, eq.~\ref{eqn:heat conduction}, eq.~\ref{eqn:acoustic power}, eq.~\ref{eqn: Stefan–Boltzmann power}). There are 

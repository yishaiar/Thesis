...
\par\noindent
Due to Brownian motion, gas particles with mass $m_0$ and velosity $v$ collide at an average collision rate of $R= \frac{N}{V} v A$, into cross section $A$ of mass $m_1$. Assuming all collisions are elastic, each particle exchange momentum of $ p = 2 m_0 v$ with $m_1$. Due to the collisions the velosity of $m_1$ is $ u = R\frac{2m_0 v}{m_1}$. Since the Brownian motion is a Poisson process, due to random time and direction the effective collision rate is the square root of the number of events. Thus, causing Brownian power $p$, which is given by:
\begin{equation}
p = F\cdot u =  \sqrt{R} p\cdot R\frac{2m_0 v}{m_1} = (\frac{N}{V} v A)^{3/2} 2 m_0 v \frac{2m_0 v}{m_1} = \frac{4}{m_1}(\frac{P}{k_B T}  A)^{3/2}  m_0^2 v^3.5  = \frac{4}{m_1} R^2 m_0^2 v^2 = \frac{4}{m_1} (\frac{N}{V} v A)^2 (\frac{M}{N_A})^2 v^2  =  \frac{36 A^2 P^2 }{m_1} =  \frac{12 APM}{N_Am_1}    \sqrt{\frac{3K N_A T}{M}} 

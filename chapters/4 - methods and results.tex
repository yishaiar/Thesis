...
\subsection{results}
The system expected $\kappa$ from the equations has a range due to uncertainty of the string tensile strength $G$. The system measured results compared to the expected results are:
\begin{multicols}{2}
\raggedcolumns
\begin{easylist}
& expected;

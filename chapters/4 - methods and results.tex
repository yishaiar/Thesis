...
\end{equation}
In this experiment due to the relatively large size and uniqe shape of the measurement equipment, the vacuum chamber is having both a large leak and outgassing rates. The sensitivity of the measuerment does not allow having the pump working, causing pressure increase over time.

...
\FloatBarrier
\par\noindent
An adjustable mount fig.~\ref{fig:mount} is soldered to the upper tube of the chamber, as shown in fig.~\ref{fig:Total chamber}. The string of the torsional pendulum is held by the mount, enabling to adjust the height, distance and angle of the pendulum relative to the viewports, placing it in front accurately. 
\begin{figure}[htbp]
	\centering

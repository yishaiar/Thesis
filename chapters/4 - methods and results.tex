...
\end{equation}
Assuming a measured mass $M$ at a given distance $r_0 = 1[m]$, the measurement sensitivity at room temperature is limited to $M\geq 2[kg]$. With the right conditions, when reaching lower damped amplitudes the resolution limit is proportional to the damping.

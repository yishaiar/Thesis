...
\FloatBarrier
\par\noindent
The upper tube of the chamber is soldered with an adjustable mount, shown in fig.~\ref{fig:mount}. The string of the torsional pendulum is held by the mount, enabling the adjustment of the string's length and placing the pendulum in front of the viewports accurately. 

...
\begin{equation}
\xi = \frac{T}{2 \pi \tau } =  \frac{T}{2 \pi  }\frac{\gamma}{2I} =\frac{T}{2 \pi  }\frac{\gamma}{2I} = \frac{\theta_{max}}{ \tau_{max}} \cdot \frac{T^2}{4\pi I}  \label{eqn:damping_time_pid}
\end{equation}
...
\begin{equation}
\tau_{max} (\xi = 1)\geq\frac{ 4 \pi I }{T}\cdot\theta_{max}^{eq} = \frac{  4 \pi \cdot 0.487\cdot10^{-3} }{(84)^2}\cdot 1\cdot10^{-6} = 5.45\cdot10^{-12}[N\cdot m]

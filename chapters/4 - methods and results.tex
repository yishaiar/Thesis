...
\begin{easylist}
& expected;
&& $I = 0.487\cdot10^{-3}[kg\cdot m^2]$ (see eq.~\ref{eqn:skin depth})
&& $\kappa = 2.1\cdot10^{-6}[\frac{N\cdot m}{rad}] - 2.6\cdot10^{-6} [\frac{N\cdot m}{rad}]$ (see eq.~\ref{eqn:skin depth})
&& $T = 96[s] - 86 [s]$ (see eq.~\ref{eqn:skin depth})
\end{easylist}
\columnbreak
\begin{easylist}
& measured;

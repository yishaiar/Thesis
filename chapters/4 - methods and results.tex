...
\begin{equation}
p = F\cdot u =  \sqrt{R} p\cdot R\frac{2m_0 v}{m_1} = (\frac{N}{V} v A)^{3/2}\frac{(2m_0 v)^2}{m_1} = \frac{4}{m_1}(\frac{P}{k_B T}  A)^{3/2}  (\frac{M}{N_A})^2 v^{3.5}  = frac{4}{m_1}(\frac{P}{k_B T}  A)^{3/2}  (\frac{M}{N_A})^2 \frac{3 R T}{M}^{3.5} 

...
\begin{equation}
p_{RMS} = A \cdot\sqrt{N}\cdot E = A\cdot\sqrt{\frac{j}{E}}\cdot E = \sqrt{\frac{\sigma\epsilon  T^4}{2.7 k_B T}}\cdot 2.7 k_B T A = \sqrt{2.7 k_B\sigma\epsilon  T^5 A^2  }   \label{eqn: max Stefan–Boltzmann power}
\end{equation} 

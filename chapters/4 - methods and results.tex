...
\end{figure}
The PID setup damping the torsional pendulum oscillation, shown in fig.~\ref{fig:measured oscillation angle1}. Since the damping is depended on the amplitude size (), the PID accelerates as the amplitude gats smaller. 
\begin{figure}[htbp]
	\centering
	\fbox{\includegraphics[scale=0.17]{\main/images/4 - methods and results/duty_cycle.png}}
	\caption[The measured oscillation angle]{The measured oscillation angle}

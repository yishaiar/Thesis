...
\end{equation}
\par\noindent
In order to overcome the led incoherent profile and large illumination angle, the light is coupled to a light guide, which is a pipe made of thin filaments causing internal reflections designe to illuminate small areas, regardless of the spectral characteristics of the light source. The light guide output is mainly dependent on the cross section and length of the lightguide, making it ideal to overcome focusing problems. 
\par\noindent
...
\begin{equation}
\tau_{PID}(t) \approx \frac{2l\eta}{{c}} (\Theta_1(t) -\Theta_2(t)) \approx \frac{2l\eta}{{c}} \cdot\frac{N V_lV_d}{100R}(D_1(t) -D_2(t))  \approx   3.56^{-12}(D_1(t) -D_2(t)) 

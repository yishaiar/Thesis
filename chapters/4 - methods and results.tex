...
\begin{equation}
p =  n_p\frac{ k^2}{m_1} =  \frac{N}{V} v A\frac{ (2 m_0 v)^2}{m_1} = \frac{4AP }{m_1k_B T}(\frac{M}{N_A})^2 (\frac{3 k_B N_A T}{M})^{3/2} =  \frac{12AP }{m_1}(\frac{M}{N_A})^2 (\frac{3 k_B N_A T}{M})^{1/2}(\frac{  N_A }{M})
...
\begin{equation}
p =  n_p\frac{ k^2}{m_1} = \frac{j_{ref}}{E}A\cdot\frac{ (\frac{2E}{c})^2}{m_1} +\frac{j_{ab}}{E}A\cdot\frac{ (\frac{E}{c})^2}{m_1} = \frac{AE}{ c^2 m_1} (4j_{ref}+j_{ab}) =\frac{A}{ c^2 m_1} (4-3\epsilon)\sigma T^4 

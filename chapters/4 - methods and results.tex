...
\par\noindent
The matching mass $m_1$ has a similar weight and shape as the mirror $m_2$, and both are connected to the pendulum via spring $w$ from their center. The spring enables accurate distance adjusting to prevent downward tilt.
\begin{figure}[htbp]
	\centering

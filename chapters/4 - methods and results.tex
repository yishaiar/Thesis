...
\FloatBarrier
\par\noindent
The design of torsional pendulum and vacuum chamber, shown in fig.~\ref{fig:Total chamber}, was carried out using the software Solid Works. The design aims to minimize environment noises. 
...
\subsubsection{Adjustable pendulum mount}
\begin{figure}[htbp]
	\centering

...
\end{equation}
In order to be able to be able to critically damp the torsional pendulum the external torque of the pid needs to be at least as large as the critical damping torqe $\tau_{critical}$:
\begin{equation}

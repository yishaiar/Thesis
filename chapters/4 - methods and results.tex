...
\par\noindent
The torsional pendulum tilt angle is measured using a mirror in front of the pendulum. Due to an unbalanced center of mass, earth's gravity causes a downward torque $\tau_y$. The center of mass is balanced using a balancing mass $m_1$ to the mirror's weight $m_2$, thus avoiding downward tilt of the mirror: 
\begin{equation}
\tau_y = r_1\cdot m_1 g \cdot cos(0) - r_2\cdot m_2 g \cdot cos (0)\ = g( r_1 m_1 - r_2 m_2)  = g( r_1 m_1 - (w-r_1) m_2)  =0    \label{eqn:downward torque}
\end{equation}
\begin{equation}

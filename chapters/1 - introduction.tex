...
Here is an example equation (from \cite{einstein1905tragheit} \cite{einstein1905tragheit} ) that has it's own label we will reference in Chapter~\ref{chp:example-2}:
\begin{equation}

...
have precision and accuracy limitations, especially at low frequencies. 
\par\noindent
...
%\par
\fi
The measurement is by the sensor's spectral density $[\frac{g}{\sqrt{Hz}}]$, where after time integration the measurement units are $[g]$. 
\par\noindent

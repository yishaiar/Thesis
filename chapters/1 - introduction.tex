...
\fi
\par\noindent
The method suggested in this paper is used to achieve a better resolution at all of the spectral density frequencies, specifically at the lower frequencies. The lower frequencies are harder to measure, but are more useful. By using various methods of noise reduction we achieved higher SNR, which allows the measurement of significantly weaker gravity field signals.
\par\noindent

...
The law of heat conduction is:
\begin{equation}
\dot{Q} = \lambda A \frac{\Delta T}{\Delta x}   \label{eqn:heat conduction}
\end{equation}
\par\noindent
Where $\dot{Q}$ is the rate of heat flow passing distance of $\Delta x$ through a material with thermal conductivity $\lambda$ with area $A$. It can be shown that for an ideal gas the thermal conductivity is:
\begin{equation}
\lambda  = \frac{1}{3}c_v\rho v l   \label{eqn:heat conduction}
\end{equation}
\begin{equation}
\Delta x ^2  = \frac{1}{3} l^2   \label{eqn:heat conduction}
\end{equation}
Where $c_v$ is the specific heat capacity of material and $l$ is the particles mean free path. The resulting rate of heat flow is:
\begin{equation}
\dot{Q} = \frac{1}{3}c_v\rho v l A \frac{\Delta T}{\sqrt{\frac{1}{3} l^2 }} = \frac{1}{\sqrt{3}}c_v\rho v A \Delta T   \label{eqn:heat conduction}
\end{equation}

%https://www.tec-science.com/thermodynamics/heat/thermal-conduction-in-solids/
\par\noindent
Since there is thermal energy coupling from the environment on the sides of the medium, reducing the number of particles also reduces the energy coupling.

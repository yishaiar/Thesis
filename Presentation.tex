...
\begin{frame}{Harmonic oscillator}
	...
	\begin{itemize}
		...
		\hyperlink{frame:Gravity measurement}{\beamerskipbutton{skip slide}}
	\end{itemize}
\end{frame}
% frame 2
...
\begin{frame}{Experiment noises}
	\begin{center}		
		\includegraphics[width=0.6\textwidth,keepaspectratio]{actual system_crop.jpg}
    \end{center}
	\begin{itemize}
		
		\item Angle measurement is optical.
		\item The measurement sensitivity is limited by noise. 
		\item Reducing the noise enables higher sensitivity.
		\pause
		\item Measurement is fundamentally limited by quantum uncertainty and shot noise. 

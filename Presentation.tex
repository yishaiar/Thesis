...
\begin{frame}{Control stability}
	...
	\end{center}
	\begin{itemize}		
		\item PID aims reaching critical damping of process, when tuned correct.
		\pause
		\item When not tuned correct; either overshoot or slow response, both result with driven oscillator.
		\item Mainly acts as friction, gradually slowing the oscillations velocity.
		\pause
		\item $\tau_{PID}(t) =  \gamma\dot{\theta}(t) =  \gamma\frac{2\pi}{T} \theta( t)$
		\item $\gamma  =\frac{\tau_{max}}{\theta_{max}}\cdot \frac{ T}{2\pi}   $

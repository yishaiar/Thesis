...
\begin{frame}{Setup design}
	...
	\begin{itemize}
		...
		\item System had undergone multiple changes; final design.
		\pause
		\item materials were chosen to reduce magnetic noise and outgassing.
...
\begin{frame}{Vacuum chamber}
	...
	\begin{itemize}
		...
		\item CF vacuum chamber; light guides and transparent windows.
		\pause
...
\begin{frame}{Torsional pendulum}
	...
	\begin{itemize}
		...
		\item Composed of thin rod, string, two masses on the sides, front mirror and a balancing mass.
		\pause
		\item The string is held by an adjustable mount, placing it accurately in front of the windows. 
		\item Maintenance of low pressure; leakage(volume) and the outgassing(surface).
		\item Measured pressure during the experiments is $P \approx  10^{-2} [pa]$.

...
\begin{frame}{Ideal gas}
	\begin{itemize}
		\item Ideal gas is gas with negligible inter-particle interactions.
		\item The pendulum interacts with an ideal gas, causing pressure-dependent friction and noises (Brownian motion, acoustic waves, thermal flow).
		\item There is also noise from environmental black body radiation.
		\pause

...
\begin{frame}{\hypertarget{frame:Environmental noises 1}{Environmental noises}}
	...
	\begin{itemize}
		...
		\item Acoustic waves are propagating with power of $p=10^{-22}AP^2$.
		\item Heat flow thermal energy exchange between physical systems $p= A P c_v \Delta T \sqrt{\frac{M}{RT}} $.

...
\begin{frame}{Experiment setup}
	...
	\begin{itemize}
		...
		\item Pendulum damped by a modulated external tourqe.
		\item A PID algorithm modulates LED light sources in real-time.
...
\begin{frame}{Previous laser setup}
	\begin{center}		
		\includegraphics[width=0.2\textwidth,keepaspectratio]{aom1.png}
	\end{center}
	\begin{itemize}		
		...
		\item Output uncertainty large; AOM response non linear.
	\end{itemize}
\end{frame}

...
\begin{frame}{\hypertarget{frame:Gravitational field}{Gravitational field}}
	...
	\begin{itemize}
		...
		\item High sensitivity is a significant challenge.
		\end{itemize}
\end{frame}
...
\begin{frame}{\hypertarget{frame:Cavendish apparatus}{Cavendish apparatus}}
	...
	\begin{itemize}
		...
		\item Apparatus measures the gravitational torque of test mass, with low .
...
\begin{center}		
	...
	\begin{itemize}
		...
		\item Torsional pendulum placed inside high vacuum and a faraday shield, with optical measurement of angular deflection.
		\item Measured down to $m = 90 [mg]$ at a low frequency band of $f = 12.7 [mHz]$.
		\item mesurements conducted in modulation band of $f = 12.7 [mHz]$, preventing high frequency coupling.
	\end{itemize}
\end{frame}

...
\begin{frame}{Harmonic oscillator}
	...
	\begin{itemize}
		...
		\item Torsional pendulum is an angular harmonic oscillator made of a mass hung by a string. 
		\item The restoring torque causes sinusoidal oscillations.
		\pause
		\item Damped oscillator if there is a damping torque opposite to the velocity $\tau = -b\dot{\theta}$.

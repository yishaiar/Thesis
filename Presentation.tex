...
\PassOptionsToPackage{unicode}{hypertree}
...
\begin{frame}{Damping results}
	...
	\begin{itemize}	
		...
		\item \textcolor{red}{Problem: noise power driving the system is unknown.}
...
\begin{frame}{\hypertarget{frame:The driving power}{The driving power}}
	...
	\begin{itemize}	
		...
		\item Coupled noise is mostly Brownian motion (negligible addition of black body radiation and acoustic waves); $p \approx 4.4\cdot 10^{-25}[W]$ 
...
\begin{frame}{\hypertarget{frame:The driving power 1}{The driving power}}
	...
	\begin{itemize}	
		\item At room temperature with pressure of $0.01[PA]$;
		\item Brownian motion: $p=\frac{12AP}{m_1}\sqrt{\frac{3 k_B T M}{ N_A }}=4.4\cdot 10^{-25}  [W]$. 
		\item Black body radiation: $p= \frac{2.7A k_B}{ c^2 m_1} (4-3\epsilon)\sigma T^5=3.2\cdot 10^{-35}$.
		\item Acoustic waves: $p=10^{-22}AP^2=1.1\cdot 10^{-28}$.
...
\begin{frame}{\hypertarget{frame:Environmental noises 1}{Environmental noises}}
	...
	\begin{itemize}
		\item Ideal gas model with negligible inter-particle interactions;
		\item Brownian motion cause random collisions $p=\frac{36A^2P^2}{m_1}$. 
		\item Net power from black body radiation is $p= A \sigma\epsilon[ T^4- T_0^4]$.
		\item Acoustic waves propagation with power of $p=10^{-22}AP^2$.
		\item Heat flow between physical systems $p= A P c_v \Delta T \sqrt{\frac{M}{RT}} $.
...
\begin{frame}{\hypertarget{frame:Environmental noises 2}{Environmental noises}}
	...
	\begin{itemize}	
		...
		\item Calculated noise: $p=0.13 [W]$.

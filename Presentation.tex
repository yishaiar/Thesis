...
\begin{frame}{\hypertarget{frame:Measurement uncertainty}{Measurement uncertainty}}
	...
	\begin{itemize}
		...
		\item $\frac{M}{r_0^3} \propto \overline{\theta}_g\pm \delta\theta \propto \overline{\theta}_g\pm \theta_{damped}$

		\item Reducing the uncertainty by damping enables higher sensitivity;

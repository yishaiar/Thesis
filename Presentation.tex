...
\begin{frame}{Arduino microcontroller}
	...
	\begin{itemize}		
		...
		\item Modulation limited by bit-rate and clock frequency: $f_{PWM} \approx 500[Hz]$.
	\end{itemize}
\end{frame}
...
\begin{frame}{LED circuit}
	...
	\end{center}
	\begin{itemize}		
		\item Circuit composed of a high power blue LED with modulated by PWM pins.
		\item LED has an approximately linear response which minimizes the overshoot.

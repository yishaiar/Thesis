...
\begin{frame}{\hypertarget{frame:Measurement uncertainty}{Measurement uncertainty}}
	...
	\begin{itemize}
		...
		\item $\frac{M}{r_0^3} \approx \frac{\overline{\theta}\pm \delta\theta}{\frac{3GT^2cos\theta sin\theta}{4\pi^2 }} \approx 5\cdot 10^{7}\cdot \overline{\theta}\pm 5\cdot 10^{7}\cdot \theta_{max}^{PID}$

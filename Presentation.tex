...
\begin{frame}{Results}
	...
	\begin{itemize}	
		...
		\item Factor is noise and amplitude depended: $Q(\theta_{max},p)  =  \frac{\pi\kappa\theta_{max}^2}{T\cdot(\frac{\theta_{max}\pi\tau_{max}}{T} -p)} $
		\item Energy dissipated is the difference of PID work and coupled noise power.

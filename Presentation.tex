...
\begin{frame}{Gravitational measurement}
	\begin{itemize}
		...
		\pause
		\item PID is not the best control algorithm (linear motion approximation, right parameters maintenance). 
		\item Next stage would include a non linear motion approximation (artificial neural network), towards the goal of damping beyond the room temperature uncertainty. 
	\end{itemize}
\end{frame}

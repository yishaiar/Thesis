...
\begin{frame}{\hypertarget{frame:LED PWM setup}{LED PWM setup}}
	...
	\begin{center}		
		\includegraphics[width=0.75\textwidth,keepaspectratio]{led_setup.png}
	\end{center}
	\begin{itemize}		
...
\begin{frame}{\hypertarget{frame:Quality factor}{Quality factor}}
	\begin{center}		
		\includegraphics[width=0.65\textwidth,keepaspectratio]{Q factor.png}
	\end{center}
	\begin{itemize}	
...
\begin{frame}{\hypertarget{frame:Effective noise}{Effective noise}}
	\begin{center}		
		\includegraphics[width=0.5\textwidth,keepaspectratio]{random_motion1.jpg}
	\end{center}

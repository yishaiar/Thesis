...
\begin{frame}{\hypertarget{frame:Quality factor}{Quality factor}}
	...
	\begin{itemize}	
		...
		\item When $Q<0$; coupled noise larger than damping process.
...
\begin{frame}{Resolution limit}
	...
	\begin{itemize}	 
		...
		\item Might allow to damp down to $\theta\approx 2\cdot 10^{-14}$ (Q factor).
		...
		\item $\frac{M}{r_0^3} \propto [\overline{\theta}_g\pm \delta\theta] \propto [\overline{\theta}_g\pm \theta_]$.			

...
\begin{frame}{Environmental noises}
	...
	\begin{itemize}
		...
		\item Interactions results with pressure-dependent friction and noises (Brownian motion, acoustic waves, thermal flow).  
...
\begin{frame}{PID response}
	...
	\end{itemize}
\end{frame}
\begin{frame}{Radiation-pressure force}
	\begin{itemize}
		...
		\item Force is modulated by light power modulation.
		
	\end{itemize}
\end{frame}
\begin{frame}{Damping tourqe }
	\begin{itemize}
		\item difference between two light sources in front of the two torsional pendulum sides.
		\item the difference between two torques adds an external net torque
		\item The radiation-pressure net torque is controlled by changing the difference between the light sources' flux
		
		
		\item The PID external correction is made by generating Radiation-pressure force.
	\end{itemize}
\end{frame}
\section{Thesis aims}

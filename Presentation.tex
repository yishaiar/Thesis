...
\framesubtitle{Setup}
    ...
    \end{center}
	\begin{itemize}
		\item The Cavendish apparatus measures the gravitational force of test mass $M$  located at distance $r_0$ using a torsional pendulum.
		\pause
		\item The mass attracts the two pendulum's masses; creating a net gravitational torques.

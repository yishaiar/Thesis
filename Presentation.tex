...
\begin{frame}{\hypertarget{frame:Effective noise}{Effective noise}}
	...
	\begin{itemize}	
		...
		\item Coupled noise is mostly Brownian motion (with negligible addition of black body radiation and acoustic waves).   	 
...
\begin{frame}{Resolution limit}
	...
	\begin{itemize}
		\item Inserting the coupled noise value to the q factor results with the possible damped angle.

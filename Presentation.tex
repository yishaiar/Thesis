...
\begin{frame}{Arduino microcontroller}
	\begin{center}		
		\includegraphics[width=0.2\textwidth,keepaspectratio]{duty_cycle.png}
	\end{center}
	\begin{itemize}		
		...
		\item Analog signal is duty cycle depended: $V(t) =  \frac{V_d}{100}\cdot D(t)$.
		\item Modulation limited by controller bit-rate and clock frequency.
	\end{itemize}
\end{frame}

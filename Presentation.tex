...
\begin{frame}{Experiment setup}
	...
	\end{center}
	\begin{itemize}
		\item Torsional pendulum with tilt angle measured by an optical readout.
		\item A feedback algorithm modulates two light sources in real-time; damping motion by external radiation pressure torque.
		\item is placed inside a vacuum chamber and an acoustic box; reducing environmental coupled noises.

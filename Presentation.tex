...
\begin{frame}{Gravitational measurement}
	\begin{itemize}
		...
		\pause
		\item Study contribution is that with the right conditions, the damping process allows to cool the torsional pendulum down to the Brownian motion limit, resulting with gravitational measurement sensitivity higher than the current state of the art.
		\pause

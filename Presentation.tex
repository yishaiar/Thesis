...
\begin{frame}{Gravitational field}
	...
	\begin{itemize}
		...
		\pause
		\item The field consisted of vectors pointing directly towards the mass: $\overrightarrow{g}(r)  = \frac{GM}{r^2}\hat{r}$ 
		\pause
		\item Since the gravitational constant is small $G = $, force is weak and hard to measure.
		\end{itemize}
\end{frame}
% frame 2

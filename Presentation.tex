...
\begin{frame}{Torsional pendulum}
	...
	\begin{itemize}
		...
		\pause
		\item String held by an adjustable mount; placing it accurately in front of windows. 
		\item Dimensions aim achieving small torsion coefficient with longer oscillation period.
		\item Measured: period $T = 84[s]$, $\kappa = 2.7\cdot10^{-6}[\frac{N\cdot m}{rad}]$.
	\end{itemize}

...
\begin{frame}{Previous achievements}
	...
	\begin{itemize}
		...
		\item Suspended superconducting sphere; sensitivity of 1 $pico-g$ after a year of integration
...
\begin{frame}{\hypertarget{frame:Cavendish apparatus}{Cavendish apparatus}}
	\begin{center}		
		\includegraphics[width=0.4\textwidth,keepaspectratio]{Cavendish apparatus.PNG}
    \end{center}
	\begin{itemize}
...
\begin{frame}{\hypertarget{frame:Measurement uncertainty}{Measurement uncertainty}}
	\begin{center}		
		\includegraphics[width=0.5\textwidth,keepaspectratio]{pendulum_front.png}
    \end{center}
	\begin{itemize}

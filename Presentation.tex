...
\begin{frame}{Resolution limit}
	...
	\begin{itemize}
		\item Inserting noise value into noise estimator from Q factor.
		\item Might allow to damp down to minimal angle of $\theta\approx 2\cdot 10^{-14}$.
...
\begin{center}		
	...
	\begin{itemize}
		...
		\item Our system is not limited to a specific spectral band due to having a tunable feedback system.

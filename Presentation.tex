...
\begin{frame}{\hypertarget{frame:The effective noise 1}{The effective noise}}
	...
	\begin{itemize}	
		\item Brownian motion net collision power: $p=\frac{12AP}{m_1}\sqrt{\frac{3 k_B T M}{ N_A }}$. 
		\item Black body radiation net collision power: $p= \frac{2.7A k_B}{ c^2 m_1} (4-3\epsilon)\sigma T^5$.

...
\begin{frame}{\hypertarget{frame:Measurement uncertainty}{Measurement uncertainty}}
	...
	\begin{itemize}
		...
		\item Reducing the uncertainty by damping enables higher sensitivity; $\frac{M}{r_0^3} \propto [\overline{\theta}_g\pm \delta\theta] = [\overline{\theta}_g\pm \theta_{damped}]$.

...
\begin{frame}{LED PWM circuit}
	\begin{center}		
		\includegraphics[width=0.55\textwidth,keepaspectratio]{duty_cycle.png}
	\end{center}
	\begin{itemize}		
		
		\item Linear response minimizes overshoot; $\tau_{PID}(t)  \approx   3\cdot 10^{-13}(D_1(t) -D_2(t)) $.
		\item PWM frequency minimizes phase delay; $f_{PWM} \approx 500[Hz]$.
		\item Illumination angle of $45^0-120^0$ making it hard to focus.
		\item The LED light sources are coupled into light guides.

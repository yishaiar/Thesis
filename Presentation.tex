...
\begin{frame}{Setup design}
	\begin{center}		
			\includegraphics[width=0.3\textwidth,keepaspectratio]{total_chamber.png}
	\end{center}
	\begin{itemize}

		\item The design was carried out using the software Solid Works.
		\item Torsional pendulum was manufactured by the university workshop.
		\pause
		\item The assembling and the experiments were performed at the lab.
		\item System had undergone multiple changes; final design of system is presented.
...
\begin{frame}{Experiment setup}
	...
	\begin{itemize}
		...
		\item CF vacuum chamber with light guides and transparent windows.
		\pause

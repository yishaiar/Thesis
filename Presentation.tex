...
\begin{frame}{Arduino microcontroller}
	...
	\begin{itemize}		
		...
		\item Modulation limited by bit-rate and clock frequency.
	\end{itemize}
\end{frame}
...
\begin{frame}{Light emitting diode (LED)}
	...
	\end{center}
	\begin{itemize}		
		\item Semiconductor light source with high power and long lifetime.
		\item Due to electrons' life time, LED can be modulated up to $100MHz$.
		\item Illumination angle varies between $45^0-120^0$ and hard to focus.

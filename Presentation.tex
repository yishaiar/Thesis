...
\begin{frame}{Ideal gas}
	\begin{itemize}
		...
		\item The pendulum interacts with an ideal gas, causing pressure-dependent noise and friction.
		\item The pendulum is subject to environmental black body radiation.
		\pause

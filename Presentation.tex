...
\begin{frame}{Damping limit}
	...
	\begin{itemize}	 
		...
		%\item Damping process can damp down up to $\delta\theta^{PID}\approx 2\cdot 10^{-14}$
		\item Achieved when damping lowers the temperature; $\delta\theta = \sqrt{\frac{k_B T}{\kappa}}$. 				
	\end{itemize}
\end{frame}

...
\begin{frame}{Gravitational measurement}
	\begin{itemize}
		...
		\pause
		\item Results suggest that the amplitude could be damped up to the Brownian motion uncertainty limit. When damping beyond the thermal energy quantum uncertainty, the damping process effectively cools down the pendulum temperature (lower  measurement fundamental limit).
		\pause

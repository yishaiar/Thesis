...
\begin{center}		
	...
	\begin{itemize}
		...
		\item A torsional pendulum placed inside high vacuum and faraday shield, with optical measurement of angular deflection.
		\item Measured down to $m = 90 [mg]$ around modulation band of $f = 12.7 [mHz]$.
	\end{itemize}
\end{frame}

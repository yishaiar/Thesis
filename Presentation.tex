...
\begin{frame}{PID response}
	...
	\end{itemize}
\end{frame}
\begin{frame}{Radiation tourqe}
	\begin{itemize}
		\item Vacuum chamber is designed with two transparent windows allowing incident light.
		\pause
		...
		\item Two modulated light source results with a modulated net tourqe.
...
\begin{frame}{Damping tourqe }
	\begin{itemize}
		...
		\item Difference between two light sources adds an external net torque.
		
		\item The radiation-pressure net torque is controlled by changing the difference between the light sources' flux
		
		
		\item The PID external correction is made by generating radiation net torque.
	\end{itemize}
\end{frame}
\section{Thesis aims}

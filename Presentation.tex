...
\begin{frame}{Laser setup}
	...
	\end{center}
	\begin{itemize}		
		\item Single laser diode coupled in series into two acousto optic modulators, dividing into two controlled beams.
		\item Modulation range of $10000$ steps and modulation frequency of $1 [Hz]$.
		\item Minimized difference uncertainty; light sources with mutual source.
		\item Large uncertainty; non linearity of the AOM response, power fluctuations.
	\end{itemize}
\end{frame}

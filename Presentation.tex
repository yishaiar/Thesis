...
\begin{frame}{\hypertarget{frame:Gravimetric measurement}{Gravitational measurement}}
	...
	\begin{itemize}
		...
		\item Introducing a new mass adds a new net torque $\tau_g$. 
...
\begin{frame}{Previous laser setup}
	...
	\begin{itemize}		
		...
		\item High modulation range of 13-bit steps.
		\item Large output uncertainty; AOM response non linear.		
...
\begin{frame}{\hypertarget{frame:LED PWM circuit}{LED PWM circuit}}
	...
	\begin{itemize}		
		...
		\item Low modulation range of 8-bit steps.
		\item Small output uncertainty; PWM response linear.		

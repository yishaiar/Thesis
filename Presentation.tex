...
\begin{frame}{Previous achievements}
	...
	\begin{itemize}
		...
		\item Interference fringe changes; sensitivity of 100 $\frac{nano-g}{\sqrt{Hz}}$. A. Peters, K. Y. Chung, and S. Chu. High-precision gravity measurements using atom
interferometry. Metrologia, 38(1):25, 2001.
...
\begin{frame}{\hypertarget{frame:Environmental noises 1}{Environmental noises}}
	...
	\begin{itemize}
		\item Ideal gas model with negligible inter-particle interactions; room temperature with pressure of $0.01[PA]$;

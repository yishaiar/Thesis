...
\begin{frame}{\hypertarget{frame:Environmental noises 1}{Environmental noises}}
	...
	\begin{itemize}
		...
		\item Brownian motion random collisions; $p=\frac{36A^2P^2}{m_1}=6.2\cdot 10^{-6}[W]$. 
		\item Black body radiation; $p= A \sigma\epsilon[ T^4- T_0^4]=0.121[W]$.
		\item Acoustic waves propagation; $p=10^{-22}AP^2=1.1\cdot 10^{-28}[W]$.
		\item Heat flow between physical systems; $p= A P c_v \Delta T \sqrt{\frac{M}{RT}} =0.083[W]$.
